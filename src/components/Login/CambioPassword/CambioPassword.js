...
class CambioPassword extends React.Component {
  ...
  submitRegister(e) {
    ...
    if (this.state.username === "") {
      this.showValidationErr("username", "Ingrese un usuario");
      return;
    }
    if (this.state.password === "") {
      this.showValidationErr("password", "Ingrese una contraseña");
      return;
    }
    if (this.state.passwordConfirm === "") {
      this.showValidationErr("passwordConfirm", "Confirme la contraseña");
      return;
    }
    if (this.state.password !== this.state.passwordConfirm) {
      this.showValidationErr("passwordConfirm", "Las contraseñas no coinciden");
      return;
    }
